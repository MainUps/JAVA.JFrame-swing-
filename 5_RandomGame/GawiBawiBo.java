...
private boolean findWinner() {
	if(compsMove == yourMove) {
		System.out.println("you=" + getMoveStr(yourMove) + ", com=" + getMoveStr(compsMove) + ": 비겼습니다. 다시 입력하세요!");
		return false;
	}
	else if((compsMove+1) % 3 == yourMove) {
		System.out.println("you=" + getMoveStr(yourMove) + ", com=" + getMoveStr(compsMove) + ": 귀하가 이겼습니다!!");
		return true;
	}
	else {
		System.out.println("you=" + getMoveStr(yourMove) + ", com=" + getMoveStr(compsMove) + ": 귀하가 졌습니다!!");
		return true;
	}
}
